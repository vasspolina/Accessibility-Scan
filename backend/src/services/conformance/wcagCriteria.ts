...
export const WCAG_21_AA_CRITERIA: WcagCriterion[] = [
  ...
  { id: "1.3.1", name: "Info and Relationships", level: "A", coverage: "automated", plain: "Do your lists and headings exist in the code as well as in the design?", failing: "Lists and headings look right on screen but the code doesn't say what they are" },
