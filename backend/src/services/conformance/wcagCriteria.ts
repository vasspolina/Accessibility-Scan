...
export const WCAG_21_AA_CRITERIA: WcagCriterion[] = [
  // ---- Perceivable ------------------------------------------------------
  { id: "1.1.1", name: "Non-text Content", level: "A", coverage: "automated", plain: "Do images have a description for people who can't see them?", failing: "Some images have no description for people who can't see them" },
  { id: "1.2.1", name: "Audio-only and Video-only (Prerecorded)", level: "A", coverage: "manual", plain: "Do audio and video have a text version?", failing: "Some audio or video has no text version" },
  { id: "1.2.2", name: "Captions (Prerecorded)", level: "A", coverage: "manual", plain: "Do your videos have captions?", failing: "Some videos have no captions for people who can't hear them" },
  { id: "1.2.3", name: "Audio Description or Media Alternative", level: "A", coverage: "manual", plain: "Do videos say out loud what's shown on screen?", failing: "Some videos never say out loud what's shown on screen" },
  ...
  { id: "1.2.5", name: "Audio Description (Prerecorded)", level: "AA", coverage: "manual", plain: "Do videos have a spoken description of what's on screen?", failing: "Some videos have no spoken description of what's on screen" },
  { id: "1.3.1", name: "Info and Relationships", level: "A", coverage: "automated", plain: "Do headings and lists work as headings and lists, not just look like them?", failing: "Some things only look like headings or lists, so a screen reader can't tell" },
  { id: "1.3.2", name: "Meaningful Sequence", level: "A", coverage: "partial", plain: "Do screen readers read the page in a sensible order?", failing: "Screen readers read some parts in a confusing order" },
  { id: "1.3.3", name: "Sensory Characteristics", level: "A", coverage: "manual", plain: "Do instructions work without seeing shape, size or position?", failing: "Some instructions only make sense if you can see shape, size or position" },
  ...
  { id: "1.3.5", name: "Identify Input Purpose", level: "AA", coverage: "automated", plain: "Do form fields say what they're for, so browsers can fill them in?", failing: "Some form fields don't say what they're for, so browsers can't fill them in" },
  { id: "1.4.1", name: "Use of Color", level: "A", coverage: "partial", plain: "Is anything shown by colour alone?", failing: "Some things are shown by colour alone, so colour-blind visitors miss them" },
  ...
  { id: "1.4.3", name: "Contrast (Minimum)", level: "AA", coverage: "automated", plain: "Is text dark enough to read against its background?", failing: "Some text is too pale to read against its background" },
  ...
  { id: "1.4.5", name: "Images of Text", level: "AA", coverage: "manual", plain: "Is text real text, rather than a picture of text?", failing: "Some text is a picture, so it blurs when someone enlarges it" },
  ...
  { id: "1.4.11", name: "Non-text Contrast", level: "AA", coverage: "automated", plain: "Are buttons and icons dark enough to make out?", failing: "Some buttons and icons are too pale to make out" },
  { id: "1.4.12", name: "Text Spacing", level: "AA", coverage: "automated", plain: "Does the page survive someone spacing out the text to read it?", failing: "Things overlap when someone spaces out the text to read it" },
  { id: "1.4.13", name: "Content on Hover or Focus", level: "AA", coverage: "manual", plain: "Can pop-ups be closed, and do they stay out of the way?", failing: "Some pop-ups can't be closed, or cover what you were reading" },

  // ---- Operable ---------------------------------------------------------
  { id: "2.1.1", name: "Keyboard", level: "A", coverage: "partial", plain: "Does everything work without a mouse?", failing: "Some things only work with a mouse" },
  ...
  { id: "2.1.4", name: "Character Key Shortcuts", level: "A", coverage: "manual", plain: "Can single-key shortcuts be turned off?", failing: "Single-key shortcuts can't be turned off, so speech users set them off by accident" },
  ...
  { id: "2.2.2", name: "Pause, Stop, Hide", level: "A", coverage: "automated", plain: "Can moving content be stopped?", failing: "Something keeps moving and can't be stopped" },
  ...
  { id: "2.5.1", name: "Pointer Gestures", level: "A", coverage: "manual", plain: "Is there a simpler way to do anything needing a swipe or pinch?", failing: "Something needs a swipe or pinch, with no simpler way to do it" },
  { id: "2.5.2", name: "Pointer Cancellation", level: "A", coverage: "manual", plain: "Can a mis-tap be taken back by sliding your finger away?", failing: "A mis-tap can't be taken back by sliding your finger away" },
  ...
  { id: "2.5.4", name: "Motion Actuation", level: "A", coverage: "manual", plain: "Is there a normal control for anything worked by shaking or tilting?", failing: "Something only works by shaking or tilting the device" },
  ...
  { id: "3.2.1", name: "On Focus", level: "A", coverage: "manual", plain: "Does anything change just from tabbing onto it?", failing: "Something changes just from tabbing onto it" },
  ...
  { id: "3.3.2", name: "Labels or Instructions", level: "A", coverage: "automated", plain: "Do form fields say what to type?", failing: "Some form fields don't say what to type" },
  ...
  { id: "4.1.2", name: "Name, Role, Value", level: "A", coverage: "automated", plain: "Do buttons and menus tell screen readers what they are?", failing: "Some buttons and menus don't tell screen readers what they are" },
